...
-- ============================================================
-- ADD Color COLUMN TO Products (run if upgrading from v2)
-- ============================================================
IF NOT EXISTS (
    SELECT * FROM sys.columns
    WHERE object_id = OBJECT_ID(N'[dbo].[Products]') AND name = 'Color'
)
BEGIN
    ALTER TABLE [dbo].[Products] ADD Color NVARCHAR(500) NULL;
    PRINT 'Color column added to Products.';
END
GO
...
-- Email: admin@conceptfactory.com  |  Password: admin123
