...
(function () {
    ...
    // selectSvc() (printing-service card toggle) now lives in
    // product-details.js, shared with hDetails.cshtml.
    ...
    window.getCustomizeCartExtras = function () {
        ...
        try {
            ...
            console.error("getCustomizeCartExtras encountered an error — falling back to a plain custom-order item", e);
            return extras;
        }
    };
    ...
    // window.selectSvc is exported by product-details.js (loaded before
    // this file — see custom.cshtml's Scripts section).
