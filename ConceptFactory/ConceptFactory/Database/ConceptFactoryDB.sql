...
BEGIN
    ...
    VALUES
        ('Basic Cotton T-Shirt', 1, 'A stylish and comfortable t-shirt made from soft, high-quality fabric. Perfect for everyday wear. Designed with a modern fit and durable print.', 'M', 500.00, 12, 'Active'),
        ('Premium Hoodie', 2, 'Warm and stylish hoodie perfect for cool weather. Made from premium fleece material.', 'L', 850.00, 8, 'Active'),
        ('Classic Polo Shirt', 3, 'Professional polo shirt suitable for casual and semi-formal occasions.', 'M', 650.00, 15, 'Inactive'),
        ('Canvas Tote Bag', 4, 'Eco-friendly canvas tote bag, perfect for custom prints and everyday use.', 'One Size', 350.00, 20, 'Active');
END
GO
...
PRINT 'ConceptFactory database schema created successfully.';
GO
