...
namespace ConceptFactory.Controllers
{
    public class HomeController : Controller
    {
        ...
        public async Task<IActionResult> SubmitOrder(
            ...
            string cartLinesJson, IFormFile? proofFile)
        {
            ...
            try
            {
                return await ProcessSubmitOrder(fullName, email, phone, address, paymentMethod, referenceNumber, cartLinesJson, proofFile);
            }
            catch (Exception ex)
            {
            ...
            string cartLinesJson, IFormFile? proofFile)
        {
            ...
            decimal downPayment = Math.Round(subtotal * 0.5m, 2);
